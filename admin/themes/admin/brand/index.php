...
//listar
$lista = $brandController->all($inicio, $maximo);
?>
        ...
        <div class="row">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-2">
                            <a href="<?= HOME; ?>/brand/create" class="btn btn-block btn-success btn-sm"><i class="fas fa-save"></i> Adicionar Parceiro</a>
                        </div>
                        <div class="col-10">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group btn-group-sm">
                                    <a href="<?= HOME; ?>/brand/update&id=<?= $post->id; ?>" class="btn btn-info"><i class="fas fa-eye"></i></a>
                                    <a href="<?= HOME; ?>/brand/index&del=<?= $post->id; ?>" onclick="return confirm('Deseja realmente excluir <?= $post->title; ?>');" title="Excluir" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                                </div>
                            </td>
                        </tr>
                        <?php
