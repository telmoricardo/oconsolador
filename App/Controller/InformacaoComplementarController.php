...
use App\DAO\InformacaoComplementarDAO;


class InformacaoComplementarController
{
    ...
    {
        $this->informacaoComplementar= new InformacaoComplementarDAO();
    }
    ...
    public function Cadastrar($data)
    {
        ...
        if($this->data != null):
            return $this->informacaoComplementar->Cadastrar($data);
        else:
            return false;
        endif;
