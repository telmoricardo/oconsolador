		...
		.initConfig({
			...
			sass: {
				...
				dist: {
					...
					files: {
						'<?= INCLUDE_PATH; ?>/assets/assets/<%= pkg.name %>.css': 'src/scss/<%= pkg.name %>.scss',
						'<?= INCLUDE_PATH; ?>/assets/assets/owl.theme.default.css': 'src/scss/owl.theme.default.scss',
						'<?= INCLUDE_PATH; ?>/assets/assets/owl.theme.green.css': 'src/scss/owl.theme.green.scss'
					}
				}
			},
			...
			autoprefixer: {
				...
				dist: {
					files: {
						'<?= INCLUDE_PATH; ?>/assets/assets/<%= pkg.name %>.css': '<?= INCLUDE_PATH; ?>/assets/assets/<%= pkg.name %>.css',
						'<?= INCLUDE_PATH; ?>/assets/assets/owl.theme.default.css': '<?= INCLUDE_PATH; ?>/assets/assets/owl.theme.default.css',
						'<?= INCLUDE_PATH; ?>/assets/assets/owl.theme.green.css': '<?= INCLUDE_PATH; ?>/assets/assets/owl.theme.green.css'
					}
				}
			},
			...
			concat: {
				dist: {
					files: {
						'<?= INCLUDE_PATH; ?>/assets/<%= pkg.name %>.js': '<%= app.src.scripts %>'
					}
				}
			},
			...
			cssmin: {
				dist: {
					files: {
						'<?= INCLUDE_PATH; ?>/assets/assets/<%= pkg.name %>.min.css': '<?= INCLUDE_PATH; ?>/assets/assets/<%= pkg.name %>.css',
						'<?= INCLUDE_PATH; ?>/assets/assets/owl.theme.default.min.css': '<?= INCLUDE_PATH; ?>/assets/assets/owl.theme.default.css',
						'<?= INCLUDE_PATH; ?>/assets/assets/owl.theme.green.min.css': '<?= INCLUDE_PATH; ?>/assets/assets/owl.theme.green.css'
					}
				}
			},
			...
			usebanner: {
				dist: {
					...
					files: {
						src: [
							'<?= INCLUDE_PATH; ?>/assets/<%= pkg.name %>.js',
							'<?= INCLUDE_PATH; ?>/assets/assets/*.css'
						]
					}
				}
			},
			...
			uglify: {
				...
				dist: {
					files: {
						'<?= INCLUDE_PATH; ?>/assets/<%= pkg.name %>.min.js': '<?= INCLUDE_PATH; ?>/assets/<%= pkg.name %>.js'
					}
				}
			},
			...
			copy: {
				distImages: {
					...
					cwd: 'src/',
					src: [ 'img/*.*' ],
					dest: '<?= INCLUDE_PATH; ?>/assets/assets'
				},

				distToDocs: {
					expand: true,
					cwd: '<?= INCLUDE_PATH; ?>/assets/',
					src: [ '**/*.*' ],
				...
				readme: {
					files: [ {
						'<?= INCLUDE_PATH; ?>/assets/LICENSE': 'LICENSE',
						'<?= INCLUDE_PATH; ?>/assets/README.md': 'README.md'
					} ]
				}
			},
