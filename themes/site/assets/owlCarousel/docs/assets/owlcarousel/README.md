...
```js
import 'owl.carousel/<?= INCLUDE_PATH; ?>/assets/assets/owl.carousel.css';
import 'owl.carousel';
```
...
```html
<link rel="stylesheet" href="/node_modules/owl.carousel/<?= INCLUDE_PATH; ?>/assets/assets/owl.carousel.min.css" />
```

```html
<link rel="stylesheet" href="/bower_components/owl.carousel/<?= INCLUDE_PATH; ?>/assets/assets/owl.carousel.min.css" />
```
...
```html
<script src="/node_modules/jquery/<?= INCLUDE_PATH; ?>/assets/jquery.js"></script>
<script src="/node_modules/owl.carousel/<?= INCLUDE_PATH; ?>/assets/owl.carousel.min.js"></script>
```

```html
<script src="/bower_components/jquery/<?= INCLUDE_PATH; ?>/assets/jquery.js"></script>
<script src="/bower_components/owl.carousel/<?= INCLUDE_PATH; ?>/assets/owl.carousel.min.js"></script>
```
